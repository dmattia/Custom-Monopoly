...
struct MyVars {
    static var monopolyBoard: [BoardSpace] = [
        MiscSpace(name: "Go", index: 0),
        Property(name: "Borgin and Burkes", cost: 60, index: 1, color: MaterialColor.brown.base),
        MiscSpace(name: "Room of Requirement",
            index: 2,
            imageLocation: "Harry Potter/hogwarts express.jpg"),
        ...
        Railroad(name: "Hufflepuff",
            cost: 200,
            index: 5,
            imageLocation: "Harry Potter/goblet_of_fire.jpg"),
        Property(name: "Private Drive",
            cost: 100,
            index: 6,
        ...
        Property(name: "The Leaky Cauldron",
            cost: 140,
            index: 13,
        ...
        Property(name: "Number 12 Grimmauld Place",
            cost: 200,
            index: 19,
        ...
        Property(name: "Dumbledore’s Office",
            cost: 280,
            index: 29,
            color: MaterialColor.yellow.base),
        ...
        Property(name: "Ministry of Magic",
            cost: 350,
            index: 37,
